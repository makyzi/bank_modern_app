...
const FeatureCard = ({ index, icon, title, content }) => (
	...
	>
		...
		<div className="flex-1 flex flex-col ml-3">
			<h4 className="font-poppins text-lg font-semibold text-white leading-[23px] mb-1">
				{title}
			</h4>
			<p className="font-poppins text-base font-normal text-dimWhite leading-[24px] mb-1">
				{content}
			</p>
		</div>
	</div>
