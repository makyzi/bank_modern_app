	...
	>
		...
		>
			...
			<div className="flex flex-row justify-between items-center w-full">
				<h1 className="flex-1 leading-[75px] ss:leading-[100px] font-poppins font-semibold ss:text-7xl text-white text-5xl">
			...
			<h1 className="leading-[75px] w-full ss:leading-[100px] font-poppins font-semibold ss:text-6xl text-white text-4xl">
				Payment method.
			</h1>
		...
		{/* Right side - robotic arm and gradients */}
		<div
